                            ...
                            <Box display='flex' gap={20}>
                                    <Box className='info'>
                                        ...
                                        <FormControl >
                                            ...
                                            <Input variant='outline' value={ data.cityOfResidence } onChange={e => setData({...data, cityOfResidence: e.target.value})} />
                                        </FormControl>

                                        <FormControl>
                                            <FormLabel color='gray.500' fontSize='md'>City of District</FormLabel>
                                            <Input variant='outline' value={ data.cityOfDistrict } onChange={e => setData({...data, cityOfDistrict: e.target.value})} />
                                        </FormControl>
                                        </Stack>
                                    </Box>
                                    ...
                                    <Box className='contact and credentials'>
                                        ...
                                        <Stack spacing='4' mt='2'>
                                            <FormControl>
                                                ...
                                                <Input variant='outline' value={ data.whatsappNo } onChange={e => setData({...data, whatsappNo: e.target.value})} />
                                            </FormControl>
                                        ...
                                        <Text fontSize='lg' fontWeight='semibold' color='gray.400'> Credentials </Text>
                                            ...
                                            <FormControl >
                                                ...
                                                <Input variant='outline' value={ data.password } onChange={e => setData({...data, password: e.target.value})} />
                                            </FormControl>
