...
export default function Appointment({ item }) {
  //   console.log(item.scheduleId.timeSlots);

  // convert selisih time ke durasi menit
    ...
    >
      <CardBody>
        ...
        <Stack
          ...
          color={"black.400"}
        >
          <Text>{timeDuration(item.scheduleId.timeSlots)} minute</Text>
          <Text>•</Text>
        ...
        >
          ...
          <Flex>
            ...
            <Text>
              ...
              -{" "}
              {new Date(item.scheduleId.timeSlots.endTime).toLocaleTimeString()}
            </Text>
          </Flex>
          <Flex>
            <Icon
